...
- **Full conventions:** see `CLAUDE.md` in this skill directory — it is the source of truth for the orchestration contract between this skill and `scripts/yt-extract.py`.
