@echo off
REM ===========================================================================
REM nb-check-scheduled.cmd — Ponte Windows -> MSYS2 per System Scheduler.
REM
...
E:\msys64\usr\bin\bash.exe --noprofile --norc "/e/AI/Claude/Trinity/scheduler/check_update_notebooklm/nb-check-scheduled.sh"
